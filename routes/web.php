...
Route::get('user/{user_id}/edit', 'UserController@edit')->middleware('login_auth', 'accsess_auth');
Route::post('user/{user_id}', 'UserController@update')->middleware('login_auth', 'accsess_auth');
